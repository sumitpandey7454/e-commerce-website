      ...
      <div style={{
        ...
        <div style={{ display:'flex', gap:0, marginBottom:24, borderBottom:'1px solid var(--border)' }}>
          {[
            ...
            <button
              key={tab.v}
              onClick={() => { setMode(tab.v); setOtpSent(false); }}
              style={{
        ...
        {mode === 'otp' && (
          <form onSubmit={handleVerifyOtp}>
            <div style={{ display:'flex', gap:8, marginBottom:12 }}>
              <input
                type="tel" placeholder="Phone number (10 digits)" maxLength={10}
        ...
        {mode === 'register' && (
          <form onSubmit={handleRegister}>
            ...
            />
            <input
              type="password" placeholder="Create password (min 8 chars)" required minLength={8}
              value={form.password} onChange={e => setField('password', e.target.value)}
              style={inputStyle}
              onFocus={e => e.target.style.borderColor = 'var(--primary)'}
              onBlur={e => e.target.style.borderColor = 'var(--border)'}
        ...
        <button
          onClick={() => toast.info('Google login requires OAuth setup in .env')}
          style={{
